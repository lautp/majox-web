            ...
            <div className='navbar-fixed'>
                <nav>
                    <div className='nav-wrapper' style={{backgroundColor:'#F15339'}}>
                        ...
                        <a href='#' className='brand-logo center hide-on-small-only' style={{paddingTop:'0.04em'}}><i><img src={logo} alt="" style={{height:'100%'}}/></i></a>
                        <a href='#' className='brand-logo hide-on-large-only' style={{paddingTop:'0.2em'}}><i><img src={logo} alt="" style={{height:'80%'}}/></i></a>
